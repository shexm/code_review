...
export const BeforeMutationMask = // commitBeforeMutationEffects
...
export const MutationMask = // commitMutationEffects
  Placement |
  Update |
  ChildDeletion |
  ContentReset |
  ...
  Hydrating |
  Visibility;
export const LayoutMask = Update | Callback | Ref | Visibility; // commitLayoutEffects
