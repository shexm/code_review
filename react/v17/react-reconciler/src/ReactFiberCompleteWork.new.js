...
function bubbleProperties(completedWork: Fiber) {
  ...
  if (!didBailout) {
      let child = completedWork.child;
      while (child !== null) {
        // beginWork更新时会将更新的结点的lanes重设为NoLanes，workInProgress.lanes = NoLanes，
        // 所以这里需要用还没有被处理的lanes来重新计算
    ...
    case HostComponent: {
      ...
      if (current !== null && workInProgress.stateNode != null) { // 更新
        ...
        if (wasHydrated) {
          ...
          const instance = createInstance( // document.createElement
            type,
            newProps,
            rootContainerInstance,
            currentHostContext,
